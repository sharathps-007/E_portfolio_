...
function Fun(){
    ...
    <div class="card-body">
      ...
      <a href="https://nitinsai381.github.io/Simon_Game/" class="btn btn-card" style={{fontSize:"1rem",backgroundColor:"aliceblue",color:"black",borderWidth:"0.1rem"}}>Play</a>
    </div>
  </div>
  <div class="card col-lg-3 col-md-4 col-sm-4 cardChanges"style={{backgroundColor:"rgb(65,65,65)",color:"aliceblue"}}>
    <div class="card-header">
    ...
    <div class="card-body">
      ...
      <a href="https://nitinsai381.github.io/dice_game/" class="btn btn-card" style={{fontSize:"1rem",backgroundColor:"aliceblue",color:"black",borderRadius:"0.5rem"}}>Toss it</a>
  ...
  <div class="card col-lg-3 col-md-4 col-sm-4 cardChanges"style={{backgroundColor:"rgb(65,65,65)",color:"aliceblue"}}>
    ...
    <div class="card-body">
      ...
      <a href="https://nitinsai381.github.io/Drum_Kit/" class="btn btn-card" style={{fontSize:"1rem",backgroundColor:"aliceblue",color:"black",borderWidth:"0.1rem"}}>Play</a>
    </div>
  </div>
  </div>
  </div>
